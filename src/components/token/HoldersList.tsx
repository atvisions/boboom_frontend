  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center space-x-2 mb-4">
        <Users className="h-5 w-5 text-[#70E000]" />
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                {/* 排名 */}
                <div className="w-8 h-8 rounded-full bg-[#70E000]/20 flex items-center justify-center">
                  <span className="text-[#70E000] font-bold text-sm">#{index + 1}</span>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {holder.is_creator && (
                      <span className="bg-[#70E000] text-black text-xs px-2 py-1 rounded-full">
                        Creator
                      </span>
                    )}
                  </div>
