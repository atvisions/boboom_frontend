...
export const metadata: Metadata = {
  ...
  description:
    "Create, trade, and incubate the next generation of meme coins. Innovative blockchain-based launchpad platform.",
...
export default async function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className="dark">
      <head></head>
      <body
        className={`${hubotSans.variable} ${exo2.variable} ${inter.variable} font-inter antialiased min-h-screen bg-background text-foreground`}
      >
        <Providers>
          <NProgressProvider />
